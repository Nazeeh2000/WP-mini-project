  ...
  <div class="p-4">
    ...
    <div class=" mt-4">
      <div style="margin: auto; justify-content: center;" class="row w-33">
        ...
        ?>
          <div class="col-3 mt-2 mr-2 ml-2 border rounded border-secondary d-flex flex-row" style="height: fit-content; padding: 20px; width: 33vw; cursor: pointer;" onclick="redirectToCourse(<?php echo $images['course_id'] ?>)">

            <div class="col-sm" style="width: 100%; ">
              <div style="width: 100%; display: inline-block; margin-right: 30px">
                <img style="width: 100%; height: auto" src=<?php echo "http://img.youtube.com/vi/" . $images['video_id'] . "/mqdefault.jpg" ?> alt=<?php echo $images['course_name']; ?> />
              </div>
              <div style="width: 100%; height: max-content; margin-top: 1vh; ">
                <p class="font-weight-bold underline-on-hover" style="font-size: large; cursor: pointer">
